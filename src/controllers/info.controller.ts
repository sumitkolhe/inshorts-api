      ...
      res.status(200).send(`<!DOCTYPE html>
        <html>
          <head>
            ...
            <meta charset="utf-8" />
            <title>Inshorts API | Sumit kolhe</title>
            <meta name="title" content="Inshorts API" />
            <meta name="description" content="Inshorts API by Sumit Kolhe." />
            <meta property="og:type" content="website" />
            <meta property="og:url" content="https://inshorts.me/" />
                  ...
                  >
                    ...
                    >
                      <div class="flex flex-col">
                        ...
                        <p class="text-neutral-500 mt-2">
                          Check out the documentation to learn how to use the inshorts API.
                        </p>
                      </div>
                      <div
                    ...
                    >
                      <div class="flex flex-col">
                        ...
                        <p class="text-neutral-500 mt-2">
                          Inshorts unofficial API is created by Sumit Kolhe. Check out my other projects at
                          github.
                        </p>
                      </div>
                      <div
                    ...
                    <a
                      target="_blank"
                      class="bg-white bg-opacity-0 border-b border-white border-opacity-5 relative -ml-px p-8 hover:bg-opacity-[3%] duration-100 group sm:col-span-4"
                      href="https://github.com/sumitkolhe/inshorts-api"
                    >
                      <div class="flex flex-col">
                        <span
                        ...
                        <p class="text-neutral-500 mt-2">
                          Inshorts API is open-source. Check out the source code at github.
                        </p>
                      </div>
                      <div
                        class="h-[200vh] border-r border-white absolute -right-px opacity-[4%] -top-[100vh] hidden sm:flex"
                    ...
                    <a
                      target="_blank"
                      class="bg-white bg-opacity-0 border-b border-white border-opacity-5 relative -ml-px p-8 hover:bg-opacity-[3%] duration-100 group sm:col-span-4"
                      href="https://github.com/sumitkolhe/inshorts-api/issues"
                    >
                      <div class="flex flex-col">
                        <span
